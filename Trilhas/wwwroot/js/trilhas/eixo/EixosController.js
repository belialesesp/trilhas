...
EixosController.$inject = ['$stateParams', '$state', '$http', 'PaginationService', 'spinnerService'];

function EixosController($stateParams, $state, $http, paginationService, spinnerService) {
    var vm = this;
    ...
    vm.init = function () {
        ...
        if ($stateParams.nome || $stateParams.excluidos || $stateParams.page || $stateParams.pageSize) {
    ...
    vm.consultar = function (page) {
        ...
        return $http.get("/eixos/quantidade", { params: vm.query }).then(success, error);
    };
    ...
    var buscar = function () {
        ...
        return $http.get("/eixos/buscar", { params: vm.query }).then(success, error).finally(onComplete);
    };
    ...
    vm.excluir = function (id) {
        ...
        var error = function (response) {
            ...
            console.log('Erro ao excluir eixo id = ' + vm.registroParaExcluir);
            vm.registroParaExcluir = null;
        };

        spinnerService.show('loader');
        return $http.delete('/eixos/excluir/' + vm.registroParaExcluir).then(success, error).finally(onComplete);
    };
