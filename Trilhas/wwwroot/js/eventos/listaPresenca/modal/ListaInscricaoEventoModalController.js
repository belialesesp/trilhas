angular
    .module('trilhasapp')
    .controller('ListaInscricaoEventoModalController', ListaInscricaoEventoModalController);

ListaInscricaoEventoModalController.$inject = ['$scope', '$q', '$http', 'PaginationService', 'ModalidadeFactory'];

function ListaInscricaoEventoModalController($scope, $q, $http, paginationService, modalidadeFactory) {
    var vm = this;
