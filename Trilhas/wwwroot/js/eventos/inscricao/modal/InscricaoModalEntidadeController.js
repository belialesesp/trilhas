angular
    .module('trilhasapp')
    .controller('InscricaoModalEntidadeController', InscricaoModalEntidadeController);

InscricaoModalEntidadeController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function InscricaoModalEntidadeController($scope, $http, paginationService, spinnerService) {
    var vm = this;
