angular
    .module('trilhasapp')
    .controller('EventoModalRecursoController', EventoModalRecursoController);

EventoModalRecursoController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function EventoModalRecursoController($scope, $http, paginationService, spinnerService) {
    var vm = this;
