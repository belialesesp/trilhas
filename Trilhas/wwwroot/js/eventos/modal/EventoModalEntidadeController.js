angular
    .module('trilhasapp')
    .controller('EventoModalEntidadeController', EventoModalEntidadeController);

EventoModalEntidadeController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function EventoModalEntidadeController($scope, $http, paginationService, spinnerService) {
    var vm = this;
    ...
    var init = function () {
        ...
        $('#modalBuscarEntidade').on('show.bs.modal', function (event) {
