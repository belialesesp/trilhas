angular.module('trilhasapp')
    .controller('CertificadosController', CertificadosController);

CertificadosController.$inject = ['$stateParams', '$state', '$http', '$q', 'PaginationService', 'spinnerService'];

function CertificadosController($stateParams, $state, $http, $q, paginationService, spinnerService) {
    var vm = this;
    ...
    vm.consultar = function (page) {
        ...
        return $http.get("/certificados/quantidade", { params: vm.query }).then(success, error);
    };
    ...
    var buscar = function () {
        ...
        return $http.get("/certificados/buscar", { params: vm.query }).then(success, error).finally(onComplete);
    };
    ...
    vm.excluir = function (id) {
        ...
        spinnerService.show('loader');
        return $http.delete('/certificados/excluir/' + vm.registroParaExcluir)
            .then(success, error)
            .finally(onComplete);
    };
