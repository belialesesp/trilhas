angular
    .module('trilhasapp')
	.controller('CursistaModalEntidadeController', CursistaModalEntidadeController);

CursistaModalEntidadeController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function CursistaModalEntidadeController($scope, $http, paginationService, spinnerService) {
    var vm = this;
    ...
    var init = function () {
		...
		$('#modalCursistaBuscarEntidade').on('show.bs.modal', function (event) {
    ...
    vm.selecionarEntidade = function (entidade) {
        $scope.selecionarEntidade(entidade);
    };
