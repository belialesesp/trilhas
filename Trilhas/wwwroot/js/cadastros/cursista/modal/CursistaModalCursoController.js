angular
    .module('trilhasapp')
	.controller('CursistaModalCursoController', CursistaModalCursoController);

CursistaModalCursoController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService', 'ModalidadeFactory'];

function CursistaModalCursoController($scope, $http, paginationService, spinnerService, modalidadeFactory) {
    var vm = this;
