angular
    .module('trilhasapp')
	.controller('CursistaModalPessoaController', CursistaModalPessoaController);

CursistaModalPessoaController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function CursistaModalPessoaController($scope, $http, paginationService, spinnerService) {
    var vm = this;
