angular
    .module('trilhasapp')
    .controller('PessoaModalEntidadeController', PessoaModalEntidadeController);

PessoaModalEntidadeController.$inject = ['$scope', '$http', 'PaginationService', 'spinnerService'];

function PessoaModalEntidadeController($scope, $http, paginationService, spinnerService) {
    var vm = this;
