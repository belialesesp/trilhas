...
namespace Trilhas.Data.Migrations
{
    ...
    [Migration("20190523123129_Evento")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Docente", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoAgenda", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoCota", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoHorario", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoInstrutor", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<long?>("InstrutorPessoaId");
                    ...
                    b.HasIndex("InstrutorPessoaId");

                    b.HasIndex("ModuloId");

                    b.HasIndex("SolucaoEducacionalId");

                    b.ToTable("EventoInstrutor");
                });

            modelBuilder.Entity("Trilhas.Data.Model.EventoRecurso", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Funcao", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoAgenda", b =>
                {
                    b.HasOne("Trilhas.Data.Model.Evento")
                        .WithMany("Agendas")
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoHorario", b =>
                {
                    b.HasOne("Trilhas.Data.Model.Docente", "Docente")
                        .WithMany()
                        .HasForeignKey("DocenteId");

                    b.HasOne("Trilhas.Data.Model.Funcao", "Funcao")
                        .WithMany()
                    ...
                    b.HasOne("Trilhas.Data.Model.LocalSala", "Sala")
                        .WithMany()
                        .HasForeignKey("LocalSalaId");

                    b.HasOne("Trilhas.Data.Model.Modulo", "Modulo")
                        .WithMany()
            ...
            modelBuilder.Entity("Trilhas.Data.Model.EventoInstrutor", b =>
                {
                    ...
                    b.HasOne("Trilhas.Data.Model.Pessoa", "Instrutor")
                        .WithMany()
                        .HasForeignKey("InstrutorPessoaId");
