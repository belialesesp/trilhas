...
namespace Trilhas.Data.Migrations
{
    ...
    [Migration("20190731135238_EventoIncluirDeclaracao")]
    partial class EventoIncluirDeclaracao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Cadastro.TipoLocalContato", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Nome = "RESIDENCIAL" },
                        new { Id = 2L, Nome = "COMERCIAL" },
                        new { Id = 3L, Nome = "CELULAR" },
                        new { Id = 4L, Nome = "OUTROS" }
                    );
                });
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Certificado", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Eventos.FuncaoDocente", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1L, Descricao = "DOCENTE" },
                        new { Id = 2L, Descricao = "DOCENTE ASSISTENTE" },
                        new { Id = 3L, Descricao = "CONFERENCISTA" },
                        new { Id = 4L, Descricao = "PALESTRANTE" },
                        new { Id = 5L, Descricao = "PAINELISTA" },
                        new { Id = 6L, Descricao = "DEBATEDOR" },
                        new { Id = 7L, Descricao = "MODERADOR" }
                    );
                });
            ...
            modelBuilder.Entity("Trilhas.Data.Model.Eventos.Evento", b =>
                {
                    b.HasOne("Trilhas.Data.Model.Certificado", "Certificado")
                        .WithMany()
                    ...
                    b.HasOne("Trilhas.Data.Model.Certificado", "DeclaracaoCursista")
                        .WithMany()
                        .HasForeignKey("DeclaracaoCursistaId");

                    b.HasOne("Trilhas.Data.Model.Certificado", "DeclaracaoDocente")
                        .WithMany()
